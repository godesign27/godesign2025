        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex py-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              ...
              <li className="text-gray-900 dark:text-white font-medium">CoreTechs Case Study</li>
            </ol>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 py-8 lg:py-12">
            ...
            <div className="lg:col-span-3 flex flex-col justify-center">
              <h1 className="text-xl md:text-2xl lg:text-3xl font-semibold text-gray-900 mb-4">
                Transform Healthcare Decisions with Data – Driven Insights
              </h1>
              <p className="text-sm lg:text-base text-gray-700 mb-4">
                Unlock contract value, optimize performance, and manage population risk—
              ...
              <div className="mt-4 lg:mt-6 bg-white/80 backdrop-blur-sm rounded-lg p-6 lg:p-8 shadow-sm">
                <h3 className="text-gray-900 font-semibold mb-4">SaaS Product Solution</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="text-gray-600 text-sm">ROLE(s)</h4>
                    <p className="text-gray-900 text-sm">Principal UX Designer + UX Director + Creative Director</p>
                  </div>
                  <div>
                    <h4 className="text-gray-600 text-sm">THE CLIENT</h4>
                    <p className="text-gray-900 text-sm">Gray Matter Analytics</p>
                  </div>
                  <div>
                    <h4 className="text-gray-600 text-sm">TOOLS</h4>
                    <p className="text-gray-900 text-sm">Sketch, Figma, Zeplin, Teams, Jira, InVision</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 text-sm">Sept 2016 - Sept 2022</p>
                  </div>
                </div>
              </div>
            </div>
