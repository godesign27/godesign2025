...
const Services: React.FC<ServicesProps> = ({ setCurrentPage }) => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12">Featured Work</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "CoreTechs Healthcare",
                description: "Redesigned a healthcare SaaS platform focusing on patient management and data visualization.",
                image: "https://images.pexels.com/photos/7089629/pexels-photo-7089629.jpeg"
              },
              {
                title: "Accenture Onboarding",
                description: "Created an intuitive onboarding experience for new employees.",
                image: "https://images.pexels.com/photos/7433822/pexels-photo-7433822.jpeg"
              },
              {
                title: "TransUnion Dashboard",
                description: "Designed a data-rich dashboard for financial insights and reporting.",
