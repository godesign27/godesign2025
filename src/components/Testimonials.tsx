        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <div className="ml-4">
                <h4 className="font-semibold text-gray-900 dark:text-white">Linda Correy</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Digital Director</p>
              </div>
            </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <div className="ml-4">
                <h4 className="font-semibold text-gray-900 dark:text-white">Damian Bell</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Product Lead</p>
              </div>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg shadow-sm">
            <div className="flex items-center mb-4">
              ...
              <div className="ml-4">
                <h4 className="font-semibold text-gray-900 dark:text-white">Dan Boyle</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Senior VP</p>
              </div>
            </div>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
